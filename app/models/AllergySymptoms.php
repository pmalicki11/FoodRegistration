<?php
  ...
  class AllergySymptoms {
    ...
    public const NOSE = 4;
    public const HEAD = 5;
    public const LUNGS = 6;
    public const EYES = 7;
    public const SHOCK = 8;
    ...
    private static $_descriptions = [
      ...
      self::LUNGS => 'Dolegliwości oddechowe - kaszel, duszności, skrócony lub świszczący oddech, chrypka',
      self::EYES => 'Doleglowości oczu - łzawienie, pieczenie',
      self::SHOCK => 'Wstrząs anafilaktyczny'
    ];
